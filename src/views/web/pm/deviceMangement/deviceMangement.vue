...
export default {
  ...
  data() {
    return {
      ...
      // list: null,
      list:[
        {id:1, title:'CS2000', memo:'2020-10发布工程使用', model:'v2.1', aisle:16, status:true},
        {id:2, title:'DGU2600', memo:'长时间运行有时有报错，长时间运行有时有报错，长时间运行有时有报错，长时间运行有时有报错，长时间运行有时有报错，', model:'v1.3', aisle:8, status:true},
      ]
    };
  },
  created() {
