  ...
  <div class="app-container" v-if="loading">
      ...
      <div class="table-layout">
        ...
        <el-row>
          ...
          <el-col :span="4" class="table-cell">
            ...
            <span>{{ addComma(value.builders)}}</span>
          </el-col>
        </el-row>
        <el-row>
    ...
    <div style="margin-top: 20px">
      <el-card class="form-container" shadow="hover" body-style="padding:0">
        <div class="operate-container-header">
          ...
          <!-- <el-button size="mini" class="el-icon-edit" @click="addServer()"></el-button> -->
          <el-button size="mini" @click="serverDialogVisible = true">添加服务器</el-button>
        </div>
    ...
    <el-card class="filter-container" shadow="hover" body-style="padding:0">
      <div class="operate-container-header">
        ...
        <el-button size="mini" @click="deliveryDialogVisible = true">我要发货</el-button>
      </div>
      <div class="table-container" style="padding: 20px">
        <el-table
          style="width: 100%"
        ...
        >
          ...
          <el-table-column label="设备总量" align="center" prop="total"></el-table-column>
          <el-table-column label="已发" align="center" prop="sent"></el-table-column>
          <el-table-column label="未发" align="center" prop="not_send"></el-table-column>
          <el-table-column label="更新时间" align="center" prop="update"></el-table-column>
        </el-table>
        <!-- 日志表格 -->
        ...
        >
          ...
          <el-table-column label="发货详情" align="center" prop="deliveryDetails"></el-table-column>
          <el-table-column label="发货人" align="center" prop="consignor"></el-table-column>
          <el-table-column label="备注" align="center" prop="remake"></el-table-column>
          <el-table-column label="附件" align="center">
            <template slot-scope="scope">
              <el-link type="primary" @click="onPreview">查看</el-link>
              <el-image-viewer
                v-if="showViewer"
                :on-close="closeViewer"
                :url-list="scope.row.href"
              />
            </template>
          </el-table-column>
        </el-table>
    ...
    <el-dialog title="发货" :visible.sync="deliveryDialogVisible" width="600px">
      ...
      >
        ...
        <el-form-item label="设备类型" prop="type">
          <el-select v-model="ruleForm.type" placeholder="请选择发货类型" @change="JudgmentDeliveryType">
            <el-option
        ...
        <el-form-item label="发货人" prop="consignor">
          <el-input v-model="ruleForm.consignor" :disabled="true" style="width: 180px"></el-input>
        </el-form-item>
        <el-form-item label="备注" prop="remake">
          <el-input type="textarea" :rows="3" v-model="ruleForm.remake" style="width: 300px"></el-input>
        </el-form-item>
    ...
    <!-- 添加服务器  弹窗 -->
    <el-dialog title="添加服务器" :visible.sync="serverDialogVisible" width="600px">
      <el-form
        :model="ruleFormForServe"
        :rules="rulesForServe"
        ref="ruleFormForServe"
        label-width="150px"
        class="demo-ruleForm"
      >
        <el-form-item label="设备名称" prop="name">
          <el-input v-model="ruleFormForServe.name" style="width: 300px"></el-input>
        </el-form-item>

        <el-form-item label="设备描述" prop="remake">
          <el-input
            type="textarea"
            :rows="3"
            v-model="ruleFormForServe.remake"
            style="width: 300px"
          ></el-input>
        </el-form-item>

        <el-form-item label="软件版本" prop="version">
          <el-input v-model="ruleFormForServe.version" style="width: 300px"></el-input>
        </el-form-item>
        <el-form-item label="IP地址" prop="IPaddress">
          <el-input v-model="ruleFormForServe.IPaddress" style="width: 300px"></el-input>
        </el-form-item>
        <el-form-item>
          <el-button type="primary" @click="submitFormForServe('ruleFormForServe')">立即添加</el-button>
          <el-button @click="resetForm('ruleFormForServe')">重置</el-button>
        </el-form-item>
      </el-form>
    </el-dialog>
  </div>
