    ...
    <el-row style="margin: 20px 10px" :gutter="20">
      ...
      <el-col :span="9">
        ...
        >
          ...
          <div style="padding: 15px 10px">
            <div id="project-the-pie-chart" />
          </div>
        </el-card>
      </el-col>
      <el-col :span="9">
        <el-card shadow="hover" style="" body-style="padding:0">
          <div class="echarts_header">实时数据</div>
          <div style="padding: 15px; height: 294px">
            <el-table
              :data="realTimeTableDataSlice"
              style="width: 100%"
            ...
            <div class="pagination-contain">
              <el-pagination
                background
                :total="realTimeTableData.length"
                :page-size="5"
...
export default {
  ...
  methods: {
    ...
    handleCurrentChange(val) {
      ...
      // 先模拟下
      if (val === 2) {
        this.realTimeTableDataSlice = this.realTimeTableData.slice(5, 9);
      } else {
        this.realTimeTableDataSlice = this.realTimeTableData.slice(0, 5);
      }
    },
